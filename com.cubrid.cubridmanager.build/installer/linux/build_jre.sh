...
cp -f ${PRODUCT_NAME}_install_with_jre.sh ${OUT_PATH}/${PRODUCT_FILE}
tar cf - ${PRODUCT_NAME}-product.tar.gz ${PRODUCT_NAME}_Setup_with_jre.sh COPYING version.sh >> ${OUT_PATH}/${PRODUCT_FILE}
