...
public class TreeNodeTest extends
		SetupEnvTestCase {
	...
	public void testMultiColon() throws Exception {
		...
		TreeNode node = MessageUtil.parseResponse(msg);
		assertEquals("C:\\CUBRID/tmp/analyzelog_5004.res",
				node.getValue("resultfile"));
	}

	public void testAddChild() throws Exception {
		String filepath = this.getFilePathInPlugin("/com/cubrid/cubridmanager/core/receive.msg/addattribute_receive");
		String msg = Tool.getFileContent(filepath);
