...
public class MyMapTest extends
		TestCase {
	public void testGroup() {
		String[] orders = {"task", "token", "dbname", "classname", "type",
				"name", "attributecount", "{attribute,attribute_order}",
				"attribute_order", "category", };
	...
	public void testMultiValues() {
		...
		String[] sendMSGOrder = new String[]{"task", "token", "dbname",
				"classname", "type", "name", "attributecount", "attribute",
				"category", };
