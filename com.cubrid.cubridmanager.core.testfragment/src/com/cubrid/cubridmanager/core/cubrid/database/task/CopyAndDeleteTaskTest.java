...
public class CopyAndDeleteTaskTest extends SetupEnvTestCase {
	...
	public void testCopyDataBase() {
		...
		if (databaseInfo == null) {
			...
			CommonUpdateTask stopTask = new CommonUpdateTask(CommonTaskName.STOP_DB_TASK_NAME, serverInfo,
...
/*		if (checkDirTask.getNoExistDirectory() != null && checkDirTask.getNoExistDirectory().length > 0) {
		...
		if (stopDb) {
			CommonUpdateTask startTask = new CommonUpdateTask(CommonTaskName.START_DB_TASK_NAME, serverInfo,
			        CommonSendMsg.getCommonDatabaseSendMsg());
	...
	public void testDeleteDataBase() {
		...
		CommonUpdateTask task = new CommonUpdateTask(CommonTaskName.DELETE_DATABASE_TASK_NAME, serverInfo,
